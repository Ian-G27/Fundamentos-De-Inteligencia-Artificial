...
#=====================================
# Red neuronal clásica (feed-forward)
#=====================================
class PositionWiseFeedForward(nn.Module):
    #======================================
    # Constriuctos con elementos necesarios
    #======================================
...
if __name__ == "__main__":
   src_vocab_size = 5000   #Número de palabras de entrada
   tgt_vocab_size = 5000   #Número de palabras para comparar
   d_model = 512           # Dimensión de los embeddings
   num_heads = 8           #Canales de atención
   num_layers = 6          #Capas
   d_ff = 2048             # Dimensión de la red feed-forward
   max_seq_length = 100    # Máxima longitud de las frases
   ...
   #=============================
   #Error medido con la entropía
   #==============================
   criterion = nn.CrossEntropyLoss(ignore_index=0)
   #===========================================
   # Método de Adam para descenso de gradiente
   #============================================
