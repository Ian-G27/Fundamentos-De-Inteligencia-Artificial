...
class agent:
    ...
    #=================================================
    # Rotacion del agente con las manecillas del reloj
    #=================================================
    def _RCW(self):
        '''
...
class maze:
    ...
    #========================================
    # Constructor del labrinto, default 10x10
    #========================================
    ...
    #===================================
    # Permitir uso del teclado  W A S D
    #===================================
    ...
    #==============================================
    # Metodo interno para encontrar la trayectoria
    #==============================================
    _tracePathList = []
    ...
    def _tracePathSingle(self, a, p, kill, showMarked, delay):
        ...
        #=========================================================
        # Eliminar agente si llega a la meta completa trayectoria
        #=========================================================
        def killAgent(a):
            '''
